...
@Command(
        ...
        aliases = {"Отправить жалобу"}
)
public class SendComplaintCommand extends TelegramCommand {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final UsersManager usersManager;
    private final ComplaintManager complaintManager;

    public SendComplaintCommand(@NonNull UsersManager usersManager, @NonNull ComplaintManager complaintManager) {
    ...
    public void onCommand(@NonNull CommandContext context, @NonNull OkHttpTelegramClient client, @NonNull Config config) {
        try {
            ...
            if (!complaintManager.hasComplaint(chatId)) {
                ...
                new MessageBuilder(client)
                        .send(context.message,
                                config.get("complaint_sent", "complaint_sent"),
                                new KeyboardBuilder().getKeyboard(getKeyboardButtons()));
            }
